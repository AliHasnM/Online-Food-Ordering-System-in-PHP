...
<body class="admin-body">
    ...
    <!-- Form Design -->
    <div id="contact-box">
        <form action="update_dish_code.php" method="post" class="form" enctype="multipart/form-data">
            <h1 class="center">Update Dish</h1>
            <input type="hidden" name="dishes_id" value="<?php echo $row['dishes_id']; ?>">
            <div class="form-group">
                <label for="name">Dish Name</label>
                <input type="text" name="dishes_name" id="dishes_name" value="<?php echo $row['dishes_name']; ?>">
            </div>
            <div class="form-group">
                <label for="name">Dish Price</label>
                <input type="text" name="dishes_price" id="dishes_price" value="<?php echo $row['dishes_price']; ?>">
            </div>
            <div class="form-group">
                <label for="name">Choose Dish Image</label>
                <input type="file" name="dishes_img" id="dishes_img">
                <input type="hidden" name="dishes_img_old" value="<?php echo $row['dishes_img']; ?>">
            </div>
            <img src="myfile/<?php echo $row['dishes_img']; ?>" alt="Image not Uploaded" width="100" height="100">
            <div class="form-group">
                <button type="submit" name="update_upload">Update</button>
            </div>
        </form>
    </div>
    <?php
