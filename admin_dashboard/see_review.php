...
<div class="contact-box">
        ...
        ?>
                <h1 class="center">Data Records</h1>
                ...
                ?>
                        <tr>
                            <!-- <td>
                                <input type="checkbox" name="del_chk[]" value="<?php echo $row['fb_id']; ?>">
                            </td> -->
                            <td><?php echo $row['fb_id']; ?></td>
                            <td><?php echo $row['fb_name']; ?></td>
                            <td><?php echo $row['fb_desc']; ?></td>
                            <td><img src="myfile/<?php echo $row['fb_img']; ?>" alt="Image not Uploaded"
                                    width="100" height="100"></td>
                            <!-- <td><?php echo $row['created']; ?></td> -->
                            <td><a onClick="return confirm('Are you Sure')"
                                    href="delete_fb.php?fb_id=<?php echo $row['fb_id']?>">Delete</a>
                            </td>
                        </tr>
                        <?php
                    }
