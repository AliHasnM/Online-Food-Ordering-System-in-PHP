...
<!-- Form Design -->
<div id="contact-box">
        <form action="code_menu.php" method="post" class="form" enctype="multipart/form-data">
            <h1 class="center">Add Menu</h1>
            <div class="form-group">
                <label for="name">Dish Name</label>
                <input type="text" name="category_name" id="dishes_name">
            </div>
            <div class="form-group">
                <label for="name">Dish Description</label>
                <input type="text" name="category_desc" id="dishes_name">
            </div>
            <div class="form-group">
    ...
    <div class="contact-box">
        ...
        ?>
                ...
                ?>
                        <tr>
                            <!-- <td>
                                <input type="checkbox" name="del_chk[]" value="<?php echo $row['category_id']; ?>">
                            </td> -->
                            <td><?php echo $row['category_id']; ?></td>
                            <td><?php echo $row['category_name']; ?></td>
                            <td><?php echo $row['category_desc']; ?></td>
                            <td><?php echo $row['category_price']; ?></td>
                            <td><img src="myfile/<?php echo $row['category_img']; ?>" alt="Image not Uploaded"
                                    width="100" height="100"></td>
                            <!-- <td><?php echo $row['created']; ?></td> -->
                            <td><a onClick="return confirm('Are you Sure')"
                                    href="delete_menu.php?category_id=<?php echo $row['category_id']?>">Delete</a>
                                &nbsp;&nbsp;<a href="update_menu.php?category_id=<?php echo $row['category_id']?>">Edit</a>
                            </td>
                        </tr>
                        <?php
                    }
